  ...
  return (
    <div className="relative h-[90vh] min-h-[600px] w-full flex items-center justify-center bg-zinc-900 rounded-b-[3rem] sm:rounded-b-[5rem] overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-6 flex flex-col items-start mt-20">
        ...
        {/* Search Bar (Pill design on desktop, card on mobile) */}
        <div className="mt-8 md:mt-12 w-full max-w-5xl bg-background/95 backdrop-blur-md rounded-3xl md:rounded-full p-4 md:p-3 shadow-xl flex flex-col md:flex-row items-center gap-4 md:gap-4 transition-all hover:shadow-2xl">
          ...
          <Button size="lg" className="w-full md:w-auto rounded-full px-8 h-12 md:h-14 text-base shrink-0">
            Buscar
          </Button>
        </div>
      </div>
